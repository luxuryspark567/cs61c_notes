...
* <mark style="color:yellow;">SMP:</mark> <mark style="color:red;">(Shared Memory)</mark> <mark style="color:red;"></mark><mark style="color:red;">Symmetric Multiprocessor</mark>
...
4. <mark style="color:yellow;">Exclusive</mark>: up-to-date data, <mark style="color:red;">**no**</mark> <mark style="color:red;"></mark><mark style="color:red;">other</mark> cache has a copy, OK to write, memory up-to-date
   ...
   * Supplies data on read instead of going to memory (<mark style="color:red;">Other cores can get copy from this cache? No, just this core has the copy, and it is why no need to go to memory</mark>)
