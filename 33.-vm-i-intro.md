...
* ﻿﻿The OS manages <mark style="color:yellow;">multiprogramming</mark>, which is <mark style="color:yellow;">running multiple applications (processes) "simultaneously" on one CPU</mark>.&#x20;
  * (vs. <mark style="color:yellow;">multiprocessing: running processes simultaneously on different CPUs</mark>. The OS also manages this.)
* ﻿﻿This is achieved via <mark style="color:yellow;">OS context switches</mark>, i.e., <mark style="color:yellow;">switches between processes</mark> very quickly (on the human time scale):
...
* ﻿﻿Contrast with <mark style="color:yellow;">SRAM (for caches)</mark>:
  * ﻿﻿<mark style="color:yellow;">Static (no capacitors) but still volatile</mark>
  * ﻿﻿<mark style="color:yellow;">Faster (0.5 ns)/more expensive/lower density</mark>
...
* ﻿﻿<mark style="color:yellow;">Solid-State Drive (SSD)</mark>
  ...
  * $0.05-0.5/GB
  * <mark style="color:yellow;">Usually flash memory</mark>
...
* ﻿﻿Operates like a <mark style="color:yellow;">"Ginormous" register file</mark>.
...
* ﻿﻿Benefits:
  * ﻿﻿<mark style="color:yellow;">Demand paging</mark> provides the ability to run programs larger than the primary memory (DRAM).
