...
More detailed explaination: [https://www.electronics-tutorials.ws/sequential/seq\_1.html](https://www.electronics-tutorials.ws/sequential/seq\_1.html)
...
It can be seen that when both inputs S = “1” and R = “1” the outputs Q and invert\_Q can be at either logic level “1” or “0”, depending upon the state of the inputs S or R BEFORE this input condition existed. Therefore the condition of S = R = “1” does not change the state of the outputs Q and the inverse of Q.

However, the input state of S = “0” and R = “0” is an undesirable or invalid condition and must be avoided. The condition of S = R = “0” causes both outputs Q and the inverse of Q to be HIGH together at logic level “1” when we would normally want Q to be the inverse of Q.
